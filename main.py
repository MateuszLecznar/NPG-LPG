...
def SprawdzWygrana():
    ...
    for Wiersz in range(0, 3):
        if ((plansza[Wiersz][0] == plansza[Wiersz][1] == plansza[Wiersz][2]) and (plansza[Wiersz][0] is not None)):
            ...
            pg.draw.line(ekran, (128, 0, 0), (0, (Wiersz + 1) * wysokosc / 3 - wysokosc / 6),
                         (szerokosc, (Wiersz + 1) * wysokosc / 3 - wysokosc / 6), 4)
            break
    ...
    for Kolumna in range(0, 3):
        if ((plansza[0][Kolumna] == plansza[1][Kolumna] == plansza[2][Kolumna]) and (plansza[0][Kolumna] is not None)):
            ...
            pg.draw.line(ekran, (128, 0, 0), ((Kolumna + 1) * szerokosc / 3 - szerokosc / 6, 0),
                         ((Kolumna + 1) * szerokosc / 3 - szerokosc / 6, szerokosc), 4)
            break
